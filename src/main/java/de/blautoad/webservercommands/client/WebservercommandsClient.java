package de.blautoad.webservercommands.client;
...
public class WebservercommandsClient implements ClientModInitializer{
    @Override
    ...
    private static void listenToClientConnections(ServerSocket serverSocket) throws IOException {
        ...
        String[] c = b.split(" ");
        String d = c[0];
        d = URLDecoder.decode(d, StandardCharsets.UTF_8.name());
